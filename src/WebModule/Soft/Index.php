...
class Soft_Index extends Controller_MainAbstract
{
	public function loadActionIndex()
	{
		...
		if(isset(phpcom::$G['channel']['module'][$modname])){
			...
			if(phpcom::$G['channel'][$chanid]['modules'] !== 'soft'){
				$chanid = 2;
			}
		}
		$this->chanid = $chanid;
		...
		$tplname = 'soft/index_' . phpcom::$G['cache']['channel']['codename'];
		if(!tplfile_exists($tplname)){
			$tplname = checktplname('soft/index', $this->chanid);
		}
