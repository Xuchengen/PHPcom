 ...
 * This File   : ThreadList.php  2013-11-7
 */
!defined('IN_PHPCOM') && exit('Access denied');

class Special_ThreadList extends Controller_ThreadList
{
	public function loadActionIndex()
	{
		$datalist = $tableIndexs = array();
		$tplname = 'special/category';
		...
		$classid = 0;
		$currname = lang('common', 'special_list', array('name' => phpcom::$G['channel'][$chanid]['subname']));
		...
		if($queries['type'] == 'hot'){
				...
				$currname = lang('common', 'special_hot', array('name' => phpcom::$G['channel'][$chanid]['subname']));
				$this->title .= " - $currname";
				...
				$currname = lang('common', 'special_digest', array('name' => phpcom::$G['channel'][$chanid]['subname']));
				$this->title .= " - $currname";
				...
				$currname = lang('common', 'special_best', array('name' => phpcom::$G['channel'][$chanid]['subname']));
				$this->title .= " - $currname";
			...
			WHERE topline='1' AND " . ($depth ? "catid='$catid'" : "rootid='$rootid'"));
				$currname = lang('common', 'special_topline', array('name' => phpcom::$G['channel'][$chanid]['subname']));
				$this->title .= " - $currname";
			...
			WHERE focus='1' AND " . ($depth ? "catid='$catid'" : "rootid='$rootid'"));
				$currname = lang('common', 'special_focus', array('name' => phpcom::$G['channel'][$chanid]['subname']));
				$this->title .= " - $currname";
			}else{
