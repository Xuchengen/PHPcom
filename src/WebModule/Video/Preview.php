 ...
 * This File   : Preview.php  2012-12-17
 */
!defined('IN_PHPCOM') && exit('Access denied');

class Video_Preview extends Controller_Preview
{

	public function loadActionIndex()
	{
		$thread = $this->loadPreviewData('video');
		$tid = $this->tid;
		$chanid = $this->chanid;
		...
		$datalist = $this->getAttachList($tid, 'video');
