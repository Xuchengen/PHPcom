 ...
 * This File   : Type.php  2013-1-7
 */
!defined('IN_PHPCOM') && exit('Access denied');

class Article_Type extends Controller_ThreadList
{
	public function loadActionIndex()
	{
		...
		$sql = DB::buildlimit("SELECT t.*,a.*,c.depth,c.basic,c.catname,c.subname,c.codename,c.prefixurl,c.prefix,c.caturl,c.color,
				ti.attachment,ti.remote,ti.thumb,ti.preview,ti.attachimg,d.classid
